...
{
    public partial class ShopTypeView : Form, IShop_TypeView
    {
        ...
        public Product_TypeViewModel ProductId
        {
            get => (Product_TypeViewModel)ProductCmb.SelectedItem;
            set => ShopCmb.SelectedItem = value;
        }
        public int Count
        {
        ...
        public void SetShopTypeBindingSource(BindingSource source)
        {
        ...
        private static ShopTypeView? instance;

        public static ShopTypeView GetInstance(Form parentContainer)
        {
